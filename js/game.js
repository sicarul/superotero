...
function create() {
    ...
    game.add.text(game.world.width - 100, 10, 'Oteros :   ', { font: '34px Arial', fill: '#fff' });

    //  Text
    stateText = game.add.text(game.world.centerX,game.world.centerY,' ', { font: '62px Arial', fill: '#fff' });
...
function collisionHandler (bullet, alien) {
    ...
    if (aliens.countLiving() == 0)
    {
        ...
        stateText.text = " Bien, venciste al Itaú! \n Volves a BeSmart \n Click para volver a jugar";
